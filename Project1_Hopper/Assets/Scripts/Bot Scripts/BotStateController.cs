...
public class BotStateController : MonoBehaviour 
{
	...
	void OnTriggerEnter (Collider col)
	{
		...
		{
			col.GetComponent<BotController> ().SetSpecialState (stateNumber, true); //True because it is entering the region
	...
	void OnTriggerExit (Collider col)
	{
		if (col.CompareTag("Player"))
		{
			col.GetComponent<BotController> ().SetSpecialState (stateNumber, false);
